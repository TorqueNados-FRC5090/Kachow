...
public class Limelight extends SubsystemBase {
    ...
    public Limelight(String Limelight) {
        ...
        this.telemetryTable = NetworkTableInstance.getDefault().getTable("SmartDashboard/" + Limelight);
    ...
    public Optional<Measurement> getMeasurement(Pose2d currentRobotPose) {
        ...
        final PoseEstimate poseEstimate_MegaTag1 = Limelighthelpers.getBotPoseEstimate_wpiBlue(Limelight);
        final PoseEstimate poseEstimate_MegaTag2 = Limelighthelpers.getBotPoseEstimate_wpiBlue_MegaTag2(Limelight);
        if (
